...
try {
    ...
    run_migration($pdo, 'create_table_subject_allocation', "CREATE TABLE IF NOT EXISTS subject_allocation (id SERIAL PRIMARY KEY, staff_id INT NOT NULL, subject_id INT NOT NULL, class_id INT, UNIQUE(staff_id, subject_id, class_id));");
